...
export const asyncRoutes = [{
    ...
    },
    {
        path: '/visualization',
        component: Layout,
        redirect: '/visualization/mobile/index',
        meta: {
            title: '可视化',
            icon: 'eye-open',
        },
        children: [{
            path: 'mobile_index',
            component: () =>
                import ('@/views/visualization/mobile/index'),
            name: 'mobileIndex',
            meta: {
                title: '移动端'
            }
            ...
            path: 'mobile_edit',
            component: () =>
                import ('@/views/visualization/mobile/edit'),
            name: 'mobileEdit',
            hidden: true,
            meta: {
                title: '移动端装修'
            ...
            path: 'pc_index',
            component: () =>
                import ('@/views/visualization/pc/index'),
            name: 'pcIndex',
            meta: {
                title: 'pc端'
            }
            ...
            path: 'pc_edit',
            component: () =>
                import ('@/views/visualization/pc/edit'),
            name: 'pcEdit',
            hidden: true,
            meta: {
                title: 'pc端装修'
